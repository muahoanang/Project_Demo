 ...
 */
public class TankCP1_Shoot1 implements Runnable {
    ...
    public TankCP1_Shoot1(ChangerMapTankCompetitor cmtc, TreeMap<Integer, Point> listPoint_screen, String message) {
        try {
            this.cmtc = cmtc;
            ...
            Logger.getLogger(TankCP1_Shoot1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        try {
            ...
            if (p != null) {
                ...
                if (p1 != null) {
                    ...
                    sendCommandUpdateMatrix_Map(cmtc.getSession(), p, p1, "cmUpmapUs");
                } else {
    ...
    private void tankNavigation(String tankname, float x, float y, String nav, String session) {
        try {
            ...
            Logger.getLogger(TankCP1_Shoot1.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private boolean matrix_Map_pointUpdate(String userSession, TreeMap<Integer, Point> listPoint, String comman) {
        ...
        } catch (Exception e) {  // tao lai lenh tank stop de gui di  khoi dong lai qua trinh choi
