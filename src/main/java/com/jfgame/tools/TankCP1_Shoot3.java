 ...
 */
public class TankCP1_Shoot3 implements Runnable {
    ...
    public TankCP1_Shoot3(ChangerMapTankCompetitor cmtc, TreeMap<Integer, Point> listPoint_screen, String message) {
        try {
            this.cmtc = cmtc;
            ...
            Logger.getLogger(TankCP1_Shoot3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        try {
            ...
            if (p != null) {
                ...
                if (p1 != null) {
                    ...
                    sendCommandUpdateMatrix_Map(cmtc.getSession(), p, p1, "tank3cmUDmapUs");
                } else {
    ...
    private void tankNavigation(String tankname, float x, float y, String nav, String session) {
        try {
            ...
            Logger.getLogger(TankCP1_Shoot3.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private boolean sendMap(String session, TreeMap<Integer, Point> listPoint) {
        ...
        try {
            ...
            if (matrix_Map_pointUpdate(session, listPointMapUp, "tank3mapUPunmove")) {
                if (matrix_Map_pointUpdate(session, listPointMapdown, "tank3mapDownunmove")) {
                    return true;
                }
